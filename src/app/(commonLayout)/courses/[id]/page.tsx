          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-700 text-sm">
                ৮ কোর্সের অ্যাপ ডেভেলপমেন্ট প্যাকেজ যার ভিতরে থাকছে সব কিছু।
                ৪৫টি লাইভ ক্লাস এবং ১০০+ ঘন্টা এক্সক্লুসিভ ভিডিও এর মাধ্যমে
                শিখবেন নানা ধরনের রিয়েল লাইফ প্রজেক্ট তৈরির পাশাপাশি পাবেন:
                ই-কমার্স সাইট, টিকিটিং সিস্টেম, টু-ডু অ্যাপ ইত্যাদির
                এক্সপেরিয়েন্স।
              </p>
              <p className="text-gray-700 text-sm">
                এছাড়া রয়েছে DSA & Problem Solving এর আলাদা স্পেশাল সেগমেন্ট,
                যেখানে LeetCode, HackerRank এবং CodeMama থেকেও প্র্যাকটিস করা
                হবে। বিশেষভাবে শেখানো হবে কিভাবে AI এর যুগে নিজেকে প্রমাণ করতে
                হবে এবং তৈরি করতে হবে DSA & Problem Solving এর স্ট্রং বেস।
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <Button variant="outline">বিনামূল্যে ক্লাস দেখুন</Button>
              </div>
            </div>
